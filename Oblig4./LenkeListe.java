...
public abstract class LenkeListe<T> implements Liste<T> {
    ...
    private class LenkeListeIterator implements Iterator<T>{//
        ...
        @Override
        public boolean hasNext() {//sjekker om vi fortsatt er innenfor rammene til lista
            return index < liste.stoerrelse();
        }

        @Override
        public T next() {//henter neste objekt i lista
    ...
    public Iterator<T> iterator(){// oppretter selve LenkelisteIteratorObjektet
